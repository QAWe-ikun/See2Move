...
DEFAULT_CHECKPOINT="runs/ai2thor_policy_10k_stay_siglip_gain_score_e25/checkpoint_best.pt"
...
DEFAULT_FEATURES="/mnt/f/see2move/features/siglip_so400m_ai2thor_oracle_10k_stay.pt"
